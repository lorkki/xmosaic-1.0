...
{
#if 0
  char *newtext = (char *)malloc (sizeof (text) + 10);
  char *newnewtext = (char *)malloc (sizeof (newtext) + 10);
#endif
...
*/
	...
	/* HText_beginAnchor(HT,
        ...
        HText_appendText(HT, "\">Earlier articles</A>");
...
*/
	...
	/* HText_beginAnchor(HT, HTAnchor_findChildAndLink(
        ...
        HText_appendText(HT, "<A HREF=\"");
        HText_appendText(HT, buffer);
        HText_appendText(HT, "\">Later articles</A>");
