                                    ...
                                    int *,compressed)
{
...
#endif
    /* This is 1 if we should transfer files whose types we don't
       recognize as binary and save them to a local file;
    ...
    /* Used to be mystrcmp all through here, but that gets
       false matches... */
    if (*extension == '.') {
	fmt =     1==caseless_equal(".html",  extension) ? WWW_HTML
		: 1==caseless_equal(".txt",   extension) ? WWW_PLAINTEXT
		: 1==caseless_equal(".text",  extension) ? WWW_PLAINTEXT
		: 1==caseless_equal(".tex",   extension) ? WWW_PLAINTEXT
		: 1==caseless_equal(".ps",    extension) ? WWW_POSTSCRIPT
		: 1==caseless_equal(".gif",   extension) ? WWW_GIF
		: 1==caseless_equal(".jpeg",  extension) ? WWW_JPEG
		: 1==caseless_equal(".jpg",   extension) ? WWW_JPEG
		: 1==caseless_equal(".au",    extension) ? WWW_AUDIO
		: 1==caseless_equal(".snd",   extension) ? WWW_AUDIO
		: 1==caseless_equal(".aiff",  extension) ? WWW_AIFF
		: 1==caseless_equal(".dvi",   extension) ? WWW_DVI
		: 1==caseless_equal(".tiff",  extension) ? WWW_TIFF
		: 1==caseless_equal(".tif",   extension) ? WWW_TIFF
		: 1==caseless_equal(".mpeg",  extension) ? WWW_MPEG
		: 1==caseless_equal(".mpg",   extension) ? WWW_MPEG
		: 1==caseless_equal(".mime",  extension) ? WWW_MIME
		: 1==caseless_equal(".xwd",   extension) ? WWW_XWD
		: 1==caseless_equal(".movie", extension) ? WWW_SGIMOVIE
		: 1==caseless_equal(".evlm",  extension) ? WWW_EVLMOVIE
		: 1==caseless_equal(".rgb",   extension) ? WWW_RGB
		: 1==caseless_equal(".rtf",   extension) ? WWW_RICHTEXT
		: 1==caseless_equal(".tar",   extension) ? WWW_TAR
		: 1==caseless_equal(".hqx",   extension) ? WWW_TAR
		: 1==caseless_equal(".uu",    extension) ? WWW_TAR
		: 1==caseless_equal(".cave",  extension) ? WWW_CAVE
		: 0==strcmp        (".Z",     extension) ? WWW_COMPRESSED
		: 0==strcmp        (".z",     extension) ? WWW_GZIPPED
		...
		: (binary_transfer ? WWW_UNKNOWN : def);	
    } else {
