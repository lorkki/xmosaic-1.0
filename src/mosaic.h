...
#define MO_VERSION_STRING "1.0"
#define MO_HELP_ON_VERSION_DOCUMENT \
  "http://hoohoo.ncsa.uiuc.edu:80/mosaic-docs/help-on-version-1.0.html"
...
#elif defined(cray)
#define MO_MACHINE_TYPE "Huge-ass Cray"
#elif defined(VMS)
...
extern mo_status mo_is_editable_annotation (char *);
