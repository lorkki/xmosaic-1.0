...
typedef enum
{
  ...
  mo_usenet_document,
  mo_njit_document,
  mo_overview_document, mo_servers_document,
  ...
  mo_mosaic_homepage, mo_mosaic_manual,
...
static mo_status mo_set_view_anchor (mo_window *win, Widget sb, char *anchor)
{
  ...
  XtVaGetValues 
    (sb, XmNminimum, (long)(&min), XmNmaximum, (long)(&max), 
     WbNcurrentPage, current_page, NULL);
                                    ...
                                    int register_visit, char *ref)
{
  ...
  if (mo_is_editable_annotation (win->current_node->text))
...
static XmxCallback (menubar_cb)
{
  ...
  switch (i)
    ...
    case mo_ncsa_document:
      mo_access_document (win, "http://hoohoo.ncsa.uiuc.edu/welcome.html");
      break;
    ...
    case mo_pmc:
      ...
      break;
    case mo_bmcr:
      mo_access_document (win, "gopher://orion.lib.Virginia.EDU:70/11/journals/bmcr");
      break;
    case mo_losalamos:
    ...
    case mo_wais_document:
      mo_access_document (win, "http://info.cern.ch/hypertext/Products/WAIS/Sources/Overview.html");
      break;
    ...
    case mo_mosaic_homepage:
      mo_access_document
        (win, "http://hoohoo.ncsa.uiuc.edu:80/mosaic-docs/mosaic-home.html");
      break;
    case mo_mosaic_manual:
      mo_access_document
        (win, "http://hoohoo.ncsa.uiuc.edu:80/mosaic-docs/mosaic-docs.html");
      break;
      /* GOPHER SERVERS */
    case mo_ncsa_gopher:
    ...
    case mo_help_about:
      mo_open_another_window
        (win, "http://hoohoo.ncsa.uiuc.edu:80/mosaic-docs/help-about.html",
         NULL, NULL);
      break;
    case mo_help_onwindow:
      mo_open_another_window
        (win, "http://hoohoo.ncsa.uiuc.edu:80/mosaic-docs/help-on-docview-window.html",
         NULL, NULL);
      break;
    case mo_help_onversion:
      ...
      break;
    case mo_help_faq:
      mo_open_another_window (win, "http://hoohoo.ncsa.uiuc.edu:80/mosaic-docs/mosaic-faq.html", NULL, NULL);
      break;
    case mo_whine:
...
static XmxMenubarStruct manp_menuspec[] =
{
  ...
  { "Internet RFC's",         'R', menubar_cb, mo_internet_rfcs },
...
{
  { "Web Overview",           'O', menubar_cb, mo_overview_document },
  { "Web Project",            'P', menubar_cb, mo_web_document },
  { "Web Servers",            'S', menubar_cb, mo_servers_document },
  { "Information By Subject", 'I', menubar_cb, mo_info_document },
  { "Data Sources By Service",'D', menubar_cb, mo_datasources_document },
  { "InterNIC Info Source",   'C', menubar_cb, mo_gopher_internic },
  { "----" },
  { "WAIS Interface",         'W', menubar_cb, mo_wais_document },
  ...
  { "Finger Interface",      NULL, menubar_cb, mo_finger_document },
  { "Hyper-G Interface",      'H', menubar_cb, mo_hyperg_document },
  { "HyTelnet Interface",     'y', menubar_cb, mo_hytelnet_document },
  { "Techinfo Interface",     'T', menubar_cb, mo_techinfo_document },
  { "TeXinfo Interface",      'X', menubar_cb, mo_texinfo_manpages },
  { "X.500 Interface",        '5', menubar_cb, mo_x500_document },
  { "Whois Interface",        'e', menubar_cb, mo_whois_document },
  { "----" },
  { "NCSA Mosaic Home Page",  'M', menubar_cb, mo_mosaic_homepage },
  { "NCSA Home Page",         'N', menubar_cb, mo_ncsa_document },
  { "CERN Home Page",         NULL, menubar_cb, mo_cern_document },
  { "Ohio State Home Page",   NULL, menubar_cb, mo_ohiostate_document },
  { "Indiana Home Page",      NULL, menubar_cb, mo_indiana_document },
  { "----" },
  { "Cornell Law School",     'L', menubar_cb, mo_law_document },
  { "Postmodern Culture",     'r', menubar_cb, mo_pmc },
  { "Bryn Mawr Classical Review", 'B', menubar_cb, mo_bmcr },
  { "Los Alamos Physics Papers", NULL, menubar_cb, mo_losalamos },
  { NULL },
};
...
static XmxCallback (anchor_cb)
{
  ...
  /* This is probably redundant, but helps when an anchor has been
     deleted and we force a history list backup. */
  /* mo_snarf_scrollbar_values (win); */
...
static mo_window *mo_open_window_internal (Widget base, mo_window *parent)
{
  ...
  win->mail_win = win->mailhot_win = win->mailhist_win = 0;
  win->print_win = 0;
...
static mo_window *mo_open_another_window_internal (mo_window *win)
{
  ...
  return mo_make_window (toplevel, win);
}
  ...
  if (!strstr (home_document, ":"))
    {
      /* Apparently trying to load a local file, without file:
         prefix.... */
      char *url = (char *)malloc ((strlen (home_document) + 8));
      sprintf (url, "file:%s\0", home_document);
      home_document = url;
    }
...
void mo_do_gui (int argc, char **argv)
{
  ...
  if (!Rdata.gethostbyname_is_evil)
    {
      struct hostent *phe;
